 ...
 * programming easier. I shot for a basic knowledge of this topic
 * I started with the List Collection which includes the classes 
 ...
 */
	...
	public static void main(String[] args) {
		...
		ArrayList<String> cities = new ArrayList<String>(
				Arrays.asList("Littleton","Boulder","Rexburg"));
		...
		/*LinkedList Is quite similar to the ArrayList the only
		 * difference is that the ArrayList is faster when searching
		 * indexes but the linkedlist is faster at deleting elements*/
...
System.out.println(vector);  
		...
		This does NOT work: hashset.add(1,"Lemon");*/
